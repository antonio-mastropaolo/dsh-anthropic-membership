window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const PLAN_CSS = [
      ".dshAmPlan-wrap{display:flex;justify-content:center;align-items:center;flex-wrap:wrap;gap:8px;width:100%;padding:4px 0 6px}",
    ...
    function AccessSwitch({ full, onChange }) {
      return jsx.jsxs("button", {
        ...
        title: full
          ? "Full access is on (danger-full-access). Click to switch to workspace-write."
          : "Workspace write. Click for full access (no approval prompts; tools run unrestricted).",
